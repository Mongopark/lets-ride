...
import { useConfirmOtpMutation } from "../../../services/resetPassword";
import { useAppDispatch, useTypedSelector } from "../../../hooks";
import { RootState } from "../../../store";
import { setPasswordResetToken } from "../../../features/registerSlice";
...
const EmailOtp = () => {
  ...
  const onSubmit = async () => {
    ...
    try {
      console.log(data);
      const confirmOtpResponse = await confirmOtp(data).unwrap();
      if (confirmOtpResponse.success) {
        ...
        dispatch(setPasswordResetToken(confirmOtpResponse.data.token));
